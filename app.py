...
latin_name_etymology = {
    ...
    "Anthreptes malacensis": "Anthreptes is derived from Greek anthos (flower) and ereptes (snatcher), meaning 'flower-pecker'. Malacensis refers to the bird's origin in Malaya (now Malaysia).",
    ...
    "Dinopium javanense": "Dinopium is derived from Greek dinos (whirl) and opion (little eye), meaning 'spiral-eyed' or 'whirling-eye', possibly referring to the bird's movements. Javanense refers to its habitat in Java.",
